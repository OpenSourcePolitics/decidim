  ...
  class Initiative < ApplicationRecord
    ...
    def publish!
      ...
      update(
        ...
        signature_end_date: signature_end_date || scoped_type.type.global_signature_end_date || Date.current + Decidim::Initiatives.default_signature_time_period_length
      )
    end
