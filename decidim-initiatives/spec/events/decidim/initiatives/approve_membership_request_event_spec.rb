...
describe Decidim::Initiatives::ApproveMembershipRequestEvent do
  ...
  describe "email_subject" do
    it "is generated correctly" do
      expect(subject.email_subject).to eq("#{author_name} accepted your application to the promoter committee")
    end
  end

  describe "email_intro" do
    it "is generated correctly" do
      expect(subject.email_intro).to eq("#{author_name} accepted your application to be part of the promoter committee for the initiative #{resource_title}.")
    end
  end
  ...
  describe "notification_title" do
    it "is generated correctly" do
      expect(subject.notification_title)
        .to eq("<a href=\"#{author_profile_url}\">#{author_name}</a> accepted your application to be part of the promoter committee for the following initiative <a href=\"#{resource_url}\">#{resource_title}</a>.")
    end
  end
end
