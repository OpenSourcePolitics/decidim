        ...
        context "when export is made by administrator on backoffice" do
          ...
          context "when creator is a unique user" do
            it "serializes author data" do
              ...
              expect(serialized["Authors"]).to include("Registration metadata" => proposal.authors.collect(&:registration_metadata))
            end
          end
          ...
          context "when creator is the organization" do
            ...
            it "serializes authors metadata" do
              ...
              expect(serialized["Authors"]).to include("Registration metadata")
            end
            ...
            it "leaves empty each values" do
              ...
              expect(serialized["Authors"]["Registration metadata"]).to be_empty
            end
          end
        end
